...
1. Under **Add Repository** page, follow the below instructions:
...
1. Under **Settings** page, follow the below instructions:
...
1. Leave everything default under **Options** and click on **Next**.
